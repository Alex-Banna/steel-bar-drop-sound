...
public class SoundEngine {
    ...
    private boolean loadClip() {
        try (InputStream stream = new BufferedInputStream(Objects.requireNonNull(this.getClass().getResourceAsStream("sound-effect.wav")))) {
            ...
            log.warn("Failed to load drop sound", e);
        }
        return false;
    }
    ...
    public void playClip() {
        ...
        if (clip == null || currentMTime != lastClipMTime || !clip.isOpen()) {
            ...
            try {
                ...
                log.warn("Failed to get clip for drop sound sound ", e);
                return;
            }
        ...
        float gain = 20f * (float) Math.log10(config.dropVolume() / 100f);
